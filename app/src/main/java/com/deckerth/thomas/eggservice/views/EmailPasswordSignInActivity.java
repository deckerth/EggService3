...
public class EmailPasswordSignInActivity extends BaseActivity implements
    ...
    public static Intent getIntent(Context context) {
        Intent intent = new Intent(context, EmailPasswordSignInActivity.class);
        return intent;
    }
    ...
    private void updateUI(FirebaseUser user) {
        ...
        if (user != null) {
            ...
            Settings.Current.setSignInMethod(BasicApp.getContext(), Settings.SignInMethod.EMAIL);
            ...
            if (mAllowDisconnect) {
                ...
                if ((group != null) && (!group.isEmpty())) {
                    startActivity(MainActivity.getIntent(EmailPasswordSignInActivity.this, ""));
                } else {
                    startActivity(GroupActivity.getIntent(EmailPasswordSignInActivity.this));
                }
            }
        } else {
